...
function Nav() {
  ...
  return (
    <div className='p-7 fixed top-0 flex bg-white  justify-between items-center w-full'>
        ...
        <ul className=' flex gap-8 text-green-700 font-bold sm:hidden'>
        ...
        { !open && < button onClick = {change}className='sm:block text-2xl bg-green-200 p-2 rounded-md hover:p-1.5 hidden' >{<IoMdMenu/>}</button>}
        {open && <ul className='sm:hidden block p-7 gap-8 text-green-700 font-bold bg-transparent w-52 absolute top-0 right-0'>
