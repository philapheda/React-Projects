...
=======
    const exam_list = prop.examlist.map(exam => <Link to = {`/exam/${exam.sub}/${exam.sub}`}  key={exam.sub+exam.year}><li className='flex flex-col p-4 rounded-md'><Exam_list_card sub = {exam.sub} year = {exam.year} score = '0' time = {exam.time} num = {exam.q}/></li></Link> )
>>>>>>> 37808630fcb77ae2b13ad7c62a239b6a6b544f41
  return (
    <div>
