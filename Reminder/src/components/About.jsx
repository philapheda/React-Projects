...
function About() {
  ...
  <h1 className="text:2xl sm:text-4xl"><span className="font-bold">About</span> <span className="font-extralight underline">Our Brand</span></h1>
  <p className="text-gray-500 text-center">Passionate About Properties, Dedicated to <br/>Your Vision</p>
  <div className="flex flex-col items-center md:felx justify-between">
    <img className = "w-3/4 md:w-1/3" src={assets.brand_img} alt="" />
